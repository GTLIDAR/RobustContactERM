...
% Load the warm start
here = pwd;
cd('../../Optimal/DistanceScaled_Joint1Penalty');
warmstart = load([here, '/../../Optimal/DistanceScaled_Joint1Penalty/ContactCart_DistanceScaled_Joint1Penalty_Optimal.mat']);
cd(here);
...
optimOptions = setOptimizerOptions(optimOptions, 'heightVariance',1e-3,'ermMode',1,...
    'uncertainty_source',RobustContactImplicitTrajectoryOptimizer.DISTANCE_UNCERTAINTY,...
    'contactCostMultiplier',1e5,'display',true);
