...
options.integration_method = WorseCaseContactImplicitTrajectoryOptimizer.BACKWARD_EULER;
prob = WorseCaseContactImplicitTrajectoryOptimizer(plant, N, Tf, options);
...
pause(0.5);
tic;
[xtraj, utraj, ltraj, mu, z, F, info] = prob.solveTraj(t_init, traj_init);
toc

save(name,'plant','xtraj','utraj','ltraj','t_init','mu','z','F','info','plant','x0','xf');
fprintf('\nWorst Case Friction Coefficient \\mu = %0.2f',mu);
