function [xtraj, utraj,z,F,info] = optimizePushBlock(plant, t_init,x0, xf, traj_init)
...
prob = prob.addRunningCost(@(t, x, u)cost(t, x, u, xf));
...
prob = prob.setSolverOptions('snopt','MajorFeasibilityTolerance',1e-3);     %Default: 1e-6
prob = prob.setSolverOptions('snopt','MajorOptimalityTolerance',1e-3);      %Default: 1e-6
