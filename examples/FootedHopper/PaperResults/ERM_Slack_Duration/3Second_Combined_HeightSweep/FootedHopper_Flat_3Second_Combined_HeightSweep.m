function FootedHopper_Flat_3Second_Combined_HeightSweep()
...
sigmas = logspace(log10(0.05), log10(0.5), 5);
...
for n = 1:length(sigmas)
    ...
    target = sprintf('ERM_HeightUncertainty_Sigma_%3.0E',sigmas(n));
