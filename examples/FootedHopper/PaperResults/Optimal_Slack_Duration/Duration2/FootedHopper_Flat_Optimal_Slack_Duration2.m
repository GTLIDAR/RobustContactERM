function FootedHopper_Flat_Optimal_Slack_Duration2()
...
% Load the warm start
here = pwd;
feasible = load([here, '/../../Feasible_Slack_Duration/Duration2/Slack_0E+00/FootedHopper_Flat_Feasible_Slack_Duration2.mat']);
