function FootedHopper_Flat_Optimal_Slack_Duration5()
...
% Load the warm start
here = pwd;
feasible = load([here, '/../../Feasible_Slack_Duration/Duration5/Slack_0E+00/FootedHopper_Flat_Feasible_Slack_Duration5.mat']);
