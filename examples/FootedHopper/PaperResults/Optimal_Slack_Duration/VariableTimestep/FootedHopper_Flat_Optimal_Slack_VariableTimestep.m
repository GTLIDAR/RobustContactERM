function FootedHopper_Flat_Optimal_Slack_VariableTimestep()
...
% Load the warm start
here = pwd;
feasible = load([here, '/../../Feasible_Slack_Duration/VariableTimesteps/Slack_0E+00/FootedHopper_Flat_Feasible_Slack_VariableTimesteps.mat']);
